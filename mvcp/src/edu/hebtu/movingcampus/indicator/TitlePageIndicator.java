 ...
 */
package edu.hebtu.movingcampus.indicator;
...
public class TitlePageIndicator extends View implements PageIndicator {
	...
	public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		// res.getColor(R.color.default_title_indicator_footer_color);
		...
		// final int defaultLinePosition =
		// res.getInteger(R.integer.default_title_indicator_line_position);
		// final int defaultSelectedColor =
		// res.getColor(R.color.default_title_indicator_selected_color);
		// final boolean defaultSelectedBold =
		// res.getBoolean(R.bool.default_title_indicator_selected_bold);
		// final int defaultTextColor =
		// res.getColor(R.color.default_title_indicator_text_color);
		...
		// final float defaultClipPadding =
		// res.getDimension(R.dimen.default_title_indicator_clip_padding);
		// final float defaultTopPadding =
		// res.getDimension(R.dimen.default_title_indicator_top_padding);
		//
		...
		// mFooterLineHeight =
		// a.getDimension(R.styleable.TitlePageIndicator_footerLineHeight,
		...
		// a.getDimension(R.styleable.TitlePageIndicator_footerIndicatorHeight,
		...
		// mLinePosition =
		// LinePosition.fromValue(a.getInteger(R.styleable.TitlePageIndicator_linePosition,
		// defaultLinePosition));
		// mTopPadding =
		// a.getDimension(R.styleable.TitlePageIndicator_topPadding,
		// defaultTopPadding);
		// mTitlePadding =
		// a.getDimension(R.styleable.TitlePageIndicator_titlePadding,
		// defaultTitlePadding);
		// mClipPadding =
		// a.getDimension(R.styleable.TitlePageIndicator_clipPadding,
		// defaultClipPadding);
		// mColorSelected =
		// a.getColor(R.styleable.TitlePageIndicator_selectedColor,
		...
		// a.getDimension(R.styleable.TitlePageIndicator_android_textSize,
		// defaultTextSize);
		// final int footerColor =
		// a.getColor(R.styleable.TitlePageIndicator_footerColor,
		// defaultFooterColor);
