...
import edu.hebtu.movingcampus.adapter.ListAdapter;
import edu.hebtu.movingcampus.utils.WebServiceUtil;
...
public class MyWeather extends BaseActivity {
	...
	public static String weatherToday = null;
	public static String weatherTomorrow = null;
	public static String weatherAfterday = null;
	public static String weatherCurrent = null;
	public static int iconToday[] = new int[2];
	public static int iconTomorrow[] = new int[2];
	public static int iconAfterday[] = new int[2];

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.weather_indicator);
	...
	public void bindButton() {
		...
		citySpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> source, View parent,
					int position, long id) {
				getWeather(citySpinner.getSelectedItem().toString());
				showWeather();
			}
