...
public class DBProvider extends ContentProvider {
	...
	static {
		...
		URIMATCHER.addURI(DatabaseColumn.AUTHORITY, CourseColumn.TABLE_NAME,
				BLOGS);
	}
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case NEWS:
			break;
		case BLOGS:
			rowId = insert(CourseColumn.TABLE_NAME, null, values);
			break;
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case NEWS:
			...
			break;
		case BLOGS:
			count = delete(CourseColumn.TABLE_NAME, selection, selectionArgs);
			notifyChange(uri);
			break;
		}
		return count;
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case NEWS:
			...
			break;
		case BLOGS:
			count = update(CourseColumn.TABLE_NAME, values, selection,
					selectionArgs);
			notifyChange(uri);
			break;
		}
