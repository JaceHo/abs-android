...
public final class SqliteWrapper {
	...
	public static Cursor query(Context context, ContentResolver resolver,
		...
		try {
			...
			LogUtil.e("Catch a SQLiteException when query: ", e.getMessage());
	...
	public static boolean requery(Context context, Cursor cursor) {
		try {
			...
			LogUtil.e("Catch a SQLiteException when requery: ", e.getMessage());
			checkSQLiteException(context, e);
			return false;
		}
	}
	...
	public static int update(Context context, ContentResolver resolver,
		...
		try {
			...
			LogUtil.e("Catch a SQLiteException when update: ", e.getMessage());
			checkSQLiteException(context, e);
			return -1;
		}
	}
	...
	public static int delete(Context context, ContentResolver resolver,
		...
		try {
			...
			LogUtil.e("Catch a SQLiteException when delete: ", e.getMessage());
			checkSQLiteException(context, e);
			return -1;
		}
	}
	...
	public static Uri insert(Context context, ContentResolver resolver,
		...
		try {
			...
			LogUtil.e("Catch a SQLiteException when insert: ", e.getMessage());
			checkSQLiteException(context, e);
			return null;
		}
	}
