...
public class CustomHttpClient {
	 ...
	 * @return
	 */
	public static String postByHttpClient(Context context, String url,
			NameValuePair... nameValuePairs) {
		log.w("postFromWebByHttpClient url = " + url);
		try {
	...
	public static String getByHttpClient(Context context, String url,
			NameValuePair... nameValuePairs) throws Exception {
		log.w("getFromWebByHttpClient url = " + url);
		try {
			// http地址
			// String httpUrl =
