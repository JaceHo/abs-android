...
JNIEXPORT jint JNICALL Java_com_cundong_utils_PatchUtils_patch(JNIEnv *env,
	...
	__android_log_print(ANDROID_LOG_INFO, "apkPatch", "old = %s ", ch[1]);
	__android_log_print(ANDROID_LOG_INFO, "apkPatch", "new = %s ", ch[2]);
	__android_log_print(ANDROID_LOG_INFO, "apkPatch", "patch = %s ", ch[3]);

	int ret = applypatch(4, ch);

	__android_log_print(ANDROID_LOG_INFO, "apkPatch", "applypatch result = %d ", ret);
