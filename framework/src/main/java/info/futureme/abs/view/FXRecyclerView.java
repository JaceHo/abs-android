...
public class FXRecyclerView extends RecyclerView implements GestureFilter.GestureListener {

    private  Context mContext;
    private boolean isLoadingData = false;
    private boolean isnomore = false;
    private int mRefreshProgressStyle = ProgressStyle.BallScaleMultiple;
    ...
    private FArrowRefreshHeader mRefreshHeader;
    ...
    public FXRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        if(pullRefreshEnabled) {
            FArrowRefreshHeader refreshHeader = new FArrowRefreshHeader(mContext);
    ...
    public void addHeaderView(View view) {
        if (pullRefreshEnabled && !(mHeaderViews.get(0) instanceof FArrowRefreshHeader)) {
            FArrowRefreshHeader refreshHeader = new FArrowRefreshHeader(mContext);
            mHeaderViews.add(0, refreshHeader);
            mRefreshHeader = refreshHeader;
            mRefreshHeader.setProgressStyle(mRefreshProgressStyle);
    ...
    public  void setRefreshHeader(FArrowRefreshHeader refreshHeader){
        mRefreshHeader = refreshHeader;
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                    && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 &&  layoutManager.getItemCount() > layoutManager.getChildCount() && !isnomore && mRefreshHeader.getState() < FArrowRefreshHeader.STATE_REFRESHING) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ( isOnTop() && pullRefreshEnabled) {
                    ...
                    if(mRefreshHeader.getVisiableHeight() > 0 && mRefreshHeader.getState() < FArrowRefreshHeader.STATE_REFRESHING ) {
