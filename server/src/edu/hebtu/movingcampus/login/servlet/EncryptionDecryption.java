...
public class EncryptionDecryption {
   ...
   public static void main(String[] args) {
	   try {
		EncryptionDecryption mi = new EncryptionDecryption("1");
		User user = new UserDao().findbyid("2011011614");
		user.setCid("2011011614");
		String res = new Gson().toJson(user);
		String test= mi.encrypt(res);
		System.out.println(test);
		String yuan = mi.decrypt(test);
