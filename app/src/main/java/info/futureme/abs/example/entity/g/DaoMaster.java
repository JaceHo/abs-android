...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        UploadLocationDao.createTable(db, ifNotExists);
        SysDictDao.createTable(db, ifNotExists);
        FileCacheDao.createTable(db, ifNotExists);
        SyncCodeDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        UploadLocationDao.dropTable(db, ifExists);
        SysDictDao.dropTable(db, ifExists);
        FileCacheDao.dropTable(db, ifExists);
        SyncCodeDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(UploadLocationDao.class);
        registerDaoClass(SysDictDao.class);
        registerDaoClass(FileCacheDao.class);
        registerDaoClass(SyncCodeDao.class);
    }
